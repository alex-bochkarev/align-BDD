...
The aim was to figure out an instance class to highlight
the possible benefits of the proposed (full-DD-based)
pipeline.
"""
...
def main():
    ...
    for i in range(1, 100 + 1):
        ...
        # save_inst(i1, i2, jm, f"instances/jUFLP/inst_{i}.json")
